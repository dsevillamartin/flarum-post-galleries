...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([new (flarum_common_extenders__WEBPACK_IMPORTED_MODULE_0___default().Admin)().setting(() => ({
  ...
  type: 'switch',
  label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans('datitisev-post-galleries.admin.settings.swiper_zoom')
}))]);
...
/* harmony export */ });
/* harmony import */ var _extend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./extend */ "./src/admin/extend.ts");
